function PaymentDecorator(manager) {
  ...
  this.init = function () {
    ...
    var envelope = {
      event: 'payment_decorator_initialized',
      message: 'payment_decorator_initialized',
      data: {}
    };
  ...
  /**
   * Блокує усі методи оплати крім direct
   * @param status true - блокує, false - розблоковує
   */
  this.toggleNonDirectPaymentMethods = function(status)
  {
    if(status){
